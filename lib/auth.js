...
var findAndUpdate = function (user, done) {
...
exports.facebookStrategy = function () {
    return new FacebookStrategy({
            ...
            callbackURL: 'http://' + process.env.SERVER_HOST +
...
exports.googleStrategy = function () {
    return new GoogleStrategy({
            ...
            returnURL: 'http://' + process.env.SERVER_HOST + '/auth/google/callback',
            realm: 'http://' + process.env.SERVER_HOST
        },
        function (accessToken, refreshToken, profile, done) {
